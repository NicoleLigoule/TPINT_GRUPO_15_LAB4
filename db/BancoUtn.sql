...
FOR EACH ROW
BEGIN
	-- checkeo de que no haya mas de 3 cuentas
	DECLARE cuentaCount INT;
    
    DECLARE ultimoCBU BIGINT;


    -- Contar la cantidad de cuentas existentes para el CUIL especificado
    SELECT COUNT(*) INTO cuentaCount
    FROM Cuenta
    WHERE Cuil_Cli_Cu = NEW.Cuil_Cli_Cu;

    -- Si ya existen 3 cuentas para el CUIL, detener la insercion
    IF cuentaCount >= 3 THEN
        SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'ya tiene 3 cuentas el cliente';
    END IF;
...
CREATE TRIGGER LimitarCuentasPorCuil
BEFORE INSERT ON Cuenta
FOR EACH ROW
BEGIN
...
-- CUENTAS DE EJEMPLO
INSERT IGNORE INTO Cuenta (Cuil_Cli_Cu, Fecha_Creacion_Cu, Id_Tipo_Cuenta, CBU_Cu, Saldo_Cu, Estado_Cu)
VALUES
...
('20-12345678-9', '2024-11-25', 1, '4567890123456789012345', 2300, 1),
('27-87654321-8', '2024-11-25', 2, '5678901234567890123456', 8000, 1),
('30-11223344-7', '2024-11-25', 1, '6789012345678901234567', 0, 1),
('20-12345678-9', '2024-10-01', 2, '7890123456789012345678', 50000, 1),
('27-87654321-8', '2024-10-15', 2, '8901234567890123456789', 12000, 1),
('30-11223344-7', '2024-11-20', 1, '9012345678901234567890', 750, 1),
('20-44556677-1', '2024-08-15', 1, '0123456789012345678901', 0, 1),
('23-99887766-2', '2024-07-18', 2, '1234567890123456789022', 4000, 1),
('27-77665544-3', '2024-09-22', 2, '2345678901234567890133', 600, 1),
('30-66778899-4', '2024-06-12', 1, '3456789012345678901244', 30000, 1),
('20-11224455-5', '2024-05-28', 2, '4567890123456789012355', 2000, 1),
('27-33445566-6', '2024-11-19', 1, '5678901234567890123466', 15000, 1),
('30-55443322-7', '2024-11-24', 1, '6789012345678901245667', 10000, 1),
('23-44332211-8', '2024-09-15', 2, '7890123456789012345688', 5000, 1),
('27-33221100-9', '2024-08-28', 2, '8901234567890123456788', 4000, 1),
('30-99882255-0', '2024-11-23', 1, '9012345678901234567899', 7500, 1),
('23-77664433-1', '2024-07-15', 1, '0123456789012345678900', 10000, 1),
('20-88996677-2', '2024-06-12', 1, '1234567890123456789001', 30000, 1),
('27-55667788-3', '2024-05-28', 2, '2345678901234567890112', 2000, 1),
('30-22334455-4', '2024-11-19', 1, '3456789012345678901123', 15000, 1),
('23-44556677-5', '2024-09-10', 2, '4567890123456789012344', 5000, 1);




INSERT IGNORE INTO Prestamo (
...
INSERT INTO bancoutn.interesxcantidaddmeses (Plazo_d_Pagos_En_meses_IXM, Interes_IXM, Meses_int) VALUES ('24M', '60.00', '24');
INSERT INTO Prestamo (Numero_de_Cuenta_Cu_Pt, Importe_solicitado_Pt, Plazo_Pago_Pt, Detalle_solicitud_Pt, Estado_Pt)
VALUES 
(1001, 5000.00, '12M', 'Préstamo personal a 12 meses', 1),
(1002, 10000.00, '24M', 'Préstamo hipotecario a 24 meses', 1),
(1003, 7500.00, '06M', 'Préstamo automotriz a 6 meses', 1);

INSERT INTO CuotasXPrestamos (ID_Prestamo_Pt_Cp, Fecha_vencimiento_Cp, N_Cuota, pagada)
VALUES
(19, '2024-01-01', 1, 1), (19, '2024-02-01', 2, 1), (19, '2024-03-01', 3, 1),
(19, '2024-04-01', 4, 1), (19, '2024-05-01', 5, 1), (19, '2024-06-01', 6, 1),
(19, '2024-07-01', 7, 1), (19, '2024-08-01', 8, 1), (19, '2024-09-01', 9, 1),
(19, '2024-10-01', 10, 1), (19, '2024-11-01', 11, 1), (19, '2024-12-01', 12, 1);
INSERT INTO CuotasXPrestamos (ID_Prestamo_Pt_Cp, Fecha_vencimiento_Cp, N_Cuota, pagada)
VALUES
(20, '2024-01-01', 1, 1), (20, '2024-02-01', 2, 1), (20, '2024-03-01', 3, 1),
(20, '2024-04-01', 4, 1), (20, '2024-05-01', 5, 1), (20, '2024-06-01', 6, 1),
(20, '2024-07-01', 7, 1), (20, '2024-08-01', 8, 1), (20, '2024-09-01', 9, 1),
(20, '2024-10-01', 10, 1), (20, '2024-11-01', 11, 1), (20, '2024-12-01', 12, 1),
(20, '2025-01-01', 13, 1), (20, '2025-02-01', 14, 1), (20, '2025-03-01', 15, 1),
(20, '2025-04-01', 16, 1), (20, '2025-05-01', 17, 1), (20, '2025-06-01', 18, 1),
(20, '2025-07-01', 19, 1), (20, '2025-08-01', 20, 1), (20, '2025-09-01', 21, 1),
(20, '2025-10-01', 22, 1), (20, '2025-11-01', 23, 1), (20, '2025-12-01', 24, 1);
INSERT INTO CuotasXPrestamos (ID_Prestamo_Pt_Cp, Fecha_vencimiento_Cp, N_Cuota, pagada) 
VALUES 
(21, '2024-01-01', 1, 1), 
(21, '2024-02-01', 2, 1), 
...
-- Insertar nuevos préstamos con plazos y montos actualizados
-- Insertar nuevos préstamos con plazos y montos actualizados
INSERT INTO Prestamo (Numero_de_Cuenta_Cu_Pt, Importe_solicitado_Pt, Plazo_Pago_Pt, Detalle_solicitud_Pt, Estado_Pt)
VALUES 
(1009, 120000.00, '06M', 'Préstamo de expansión a 6 meses', 1),
(1010, 110000.00, '03M', 'Préstamo a corto plazo a 3 meses', 1),
(1011, 130000.00, '12M', 'Préstamo para construcción a 12 meses', 1);

-- Insertar cuotas para el préstamo 22 (12 meses)
INSERT INTO CuotasXPrestamos (ID_Prestamo_Pt_Cp, Fecha_vencimiento_Cp, N_Cuota, pagada)
VALUES
(22, '2024-01-01', 1, 1), (22, '2024-02-01', 2, 1), (22, '2024-03-01', 3, 1),
(22, '2024-04-01', 4, 1), (22, '2024-05-01', 5, 1), (22, '2024-06-01', 6, 1),
(22, '2024-07-01', 7, 1), (22, '2024-08-01', 8, 1), (22, '2024-09-01', 9, 1),
(22, '2024-10-01', 10, 1), (22, '2024-11-01', 11, 1), (22, '2024-12-01', 12, 1);

-- Insertar cuotas para el préstamo 23 (24 meses)
INSERT INTO CuotasXPrestamos (ID_Prestamo_Pt_Cp, Fecha_vencimiento_Cp, N_Cuota, pagada)
VALUES
(23, '2024-01-01', 1, 1), (23, '2024-02-01', 2, 1), (23, '2024-03-01', 3, 1),
(23, '2024-04-01', 4, 1), (23, '2024-05-01', 5, 1), (23, '2024-06-01', 6, 1),
(23, '2024-07-01', 7, 1), (23, '2024-08-01', 8, 1), (23, '2024-09-01', 9, 1),
(23, '2024-10-01', 10, 1), (23, '2024-11-01', 11, 1), (23, '2024-12-01', 12, 1),
(23, '2025-01-01', 13, 1), (23, '2025-02-01', 14, 1), (23, '2025-03-01', 15, 1),
(23, '2025-04-01', 16, 1), (23, '2025-05-01', 17, 1), (23, '2025-06-01', 18, 1),
(23, '2025-07-01', 19, 1), (23, '2025-08-01', 20, 1), (23, '2025-09-01', 21, 1),
(23, '2025-10-01', 22, 1), (23, '2025-11-01', 23, 1), (23, '2025-12-01', 24, 1);

-- Insertar cuotas para el préstamo 24 (6 meses)
INSERT INTO CuotasXPrestamos (ID_Prestamo_Pt_Cp, Fecha_vencimiento_Cp, N_Cuota, pagada)
VALUES
(24, '2024-01-01', 1, 1), (24, '2024-02-01', 2, 1), (24, '2024-03-01', 3, 1),
(24, '2024-04-01', 4, 1), (24, '2024-05-01', 5, 1), (24, '2024-06-01', 6, 1);