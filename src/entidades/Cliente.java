...
public class Cliente {
	...
	public Cliente(String cuil, int dni, String nombre, String apellido, int id_sexo, String id_nacionalidad,
			LocalDate fechaNacimiento, String direccion, int id_localidad, String correo, boolean estado) {
		super();
		this.cuil = cuil;
		this.dni = dni;
		this.nombre = nombre;
	...
	public String toString() {
		return "Cliente [cuil=" + cuil + ", dni=" + dni + ", nombre=" + nombre + ", apellido=" + apellido + ", id_sexo="
				...
				+ ", direccion=" + direccion + ", id_localidad=" + id_localidad + ", correo=" + correo + ", estado="
				+ estado + "]";
	}
